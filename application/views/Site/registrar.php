...
<body class="bg-gradient-primary">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?php echo base_url().'guardar-agencia'?>">
    ...
    <script src="<?php echo base_url().BASE_DASHBOARD_TEMPLATE.'vendor/jquery/jquery.min.js' ?>"></script>
    <script src="<?php echo base_url().BASE_DASHBOARD_TEMPLATE.'vendor/bootstrap/js/bootstrap.bundle.min.js' ?>"></script>

    <!-- Core plugin JavaScript-->
    <script src="<?php echo base_url().BASE_DASHBOARD_TEMPLATE.'vendor/jquery-easing/jquery.easing.min.js' ?>"></script>
